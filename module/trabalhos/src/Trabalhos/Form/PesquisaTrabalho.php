   ...
   public function __construct($name, $serviceLocator, $empresa)
    {
        ...
        $this->_addDropdown('avaliacoes', 'Avaliações: ', false, array('' => '-- Selecione --', 0 => 'Zero', 1 => 'Uma', 2 => 'Duas', 3 => 'Três'));

        $this->genericTextInput('titulo', 'Título:', false, 'Título do trabalho');

        $this->genericTextInput('autores', 'Autores:', false, 'Autores');
